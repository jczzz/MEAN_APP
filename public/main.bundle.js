...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_contact_list_contact_list_component__ = __webpack_require__("../../../../../src/app/components/contact-list/contact-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_contact_details_contact_details_component__ = __webpack_require__("../../../../../src/app/components/contact-details/contact-details.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_users_users_routing__ = __webpack_require__("../../../../../src/app/components/users/users.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_users_users_module__ = __webpack_require__("../../../../../src/app/components/users/users.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'contact', component: __WEBPACK_IMPORTED_MODULE_16__components_contact_list_contact_list_component__["a" /* ContactListComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__components_contact_list_contact_list_component__["a" /* ContactListComponent */],
                __WEBPACK_IMPORTED_MODULE_17__components_contact_details_contact_details_component__["a" /* ContactDetailsComponent */]
            ],
            imports: [
                ...
                //   MaterializeModule,
                __WEBPACK_IMPORTED_MODULE_20__components_users_users_module__["a" /* UsersModule */],
                __WEBPACK_IMPORTED_MODULE_19__components_users_users_routing__["a" /* usersRouting */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_contact__ = __webpack_require__("../../../../../src/app/services/contact.ts");
...
var ContactDetailsComponent = (function () {
    ...
    ContactDetailsComponent.prototype.createContact = function (contact) {
        ...
        this.contactService.createContact(contact) //此处用来更新数据库
            ...
            _this.createHandler(newContact); //此处相当于调用的父组件内的AddContact()来更新local contact list
        });
    };
    ...
    ContactDetailsComponent.prototype.deleteContact = function (contactId) {
        ...
        this.contactService.deleteContact(contactId)
            .then(function (deletedContactId) {
            _this.deleteHandler(deletedContactId);
        });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__services_contact__["a" /* Contact */])
    ...
    ContactDetailsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../src/app/components/contact-details/contact-details.component.html"),
            styles: [__webpack_require__("../../../../../src/app/components/contact-details/contact-details.component.css")]
        }),
...
module.exports = "\n<!-- 注意：this template (or view) displays a contact list and also includes the contact-details template-->\n\n<div class=\"row\">\n  <div class=\"col-md-5\">\n    <h2>Contacts</h2>\n\n    <ul class=\"list-group\">\n<!-- 使用指令ngFor 从当地变量contacts（数组）提取单个对象，然后使用插值绑定{{contact.name}},\n     渲染到模板. 同时使用事件绑定（click）=\"selectContact(contact)\"-->\n      <li class=\"list-group-item\"\n        *ngFor=\"let contact of contacts\"\n        (click)=\"selectContact(contact)\"\n        [class.active]=\"contact === selectedContact\">\n        {{contact.name}}\n      </li><!--当表达式（contact === selectedContact）true时，angular添加一个CSS类 .active,  false时，移除.actice类-->\n    </ul>\n    <button class=\"btn btn-warning\" (click)=\"createNewContact()\">New</button>\n\n  </div>\n  <!--当点击contact对象，或者点击Botton键，都会最终赋值 变量（属性）selectedContact-->\n\n\n   <!--此部分图示是用来显示click事件 激发的某个contact detail-->\n  <div class=\"col-md-5 col-md-offset-2\">\n    <!-- 另一个组件（contact-details)图示的嵌套\n    The contact-details template allows users to \n    create(post), view(get）, modify（update), and delete(del) \n    contacts from the contact list -->\n    <contact-details\n      [contact]=\"selectedContact\"\n      [createHandler]=\"addContact\"\n      [updateHandler]=\"updateContact\"\n      [deleteHandler]=\"deleteContact\">\n   </contact-details>   <!--核心！用 [属性绑定]  将父组件内的变量属性和方法 绑定到 子组件内的属性和方法（input 外部属性）\n                        从而导致 父组件内属性随着子组件变更而变更  -->\n  </div>\n</div>"
...
/***/ "../../../../../src/app/components/users/shared/address.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/components/users/shared/user.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return User; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__address__ = __webpack_require__("../../../../../src/app/components/users/shared/address.ts");
...
/***/ "../../../../../src/app/components/users/shared/users.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/components/users/user-form/user-form.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_user__ = __webpack_require__("../../../../../src/app/components/users/shared/user.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_users_service__ = __webpack_require__("../../../../../src/app/components/users/shared/users.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_basic_validators__ = __webpack_require__("../../../../../src/app/shared/basic-validators.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserFormComponent = (function () {
    function UserFormComponent(formBuilder, router, route, usersService) {
        ...
        this.form = formBuilder.group({
            ...
            address: formBuilder.group({
                street: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].minLength(3)],
                suite: [],
                city: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].maxLength(30)],
                zipcode: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].pattern('^([0-9]){5}([-])([0-9]){4}$')]
            })
        });
    }
    ...
    UserFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../src/app/components/users/user-form/user-form.component.html"),
            styles: [__webpack_require__("../../../../../src/app/components/users/user-form/user-form.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */],
            __WEBPACK_IMPORTED_MODULE_4__shared_users_service__["a" /* UsersService */]])
    ], UserFormComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_users_service__ = __webpack_require__("../../../../../src/app/components/users/shared/users.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UsersComponent = (function () {
    ...
    UsersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_users_service__["a" /* UsersService */]])
    ], UsersComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__users_component__ = __webpack_require__("../../../../../src/app/components/users/users.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_users_service__ = __webpack_require__("../../../../../src/app/components/users/shared/users.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__user_form_user_form_component__ = __webpack_require__("../../../../../src/app/components/users/user-form/user-form.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "../../../../../src/app/components/users/users.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_form_user_form_component__ = __webpack_require__("../../../../../src/app/components/users/user-form/user-form.component.ts");
...
var usersRouting = __WEBPACK_IMPORTED_MODULE_0__angular_router__["c" /* RouterModule */].forChild(usersRoutes);
...
var ContactService = (function () {
    ...
    // get("/api/contacts") : Promise<void | Contact[]>
    ContactService.prototype.getContacts = function () {
        return this.http.get(this.contactsUrl)
            .toPromise()
            .then(function (response) { return response.json(); }) //学习  as Contact[]
            .catch(this.handleError);
    };
    // post("/api/contacts") : Promise<void | Contact>
    ...
    // delete("/api/contacts/:id")      :Promise<void | String> 
    ContactService.prototype.deleteContact = function (delContactId) {
        return this.http.delete(this.contactsUrl + '/' + delContactId)
            .toPromise()
            .then(function (response) { return response.json(); }) // as String
            .catch(this.handleError);
    };
    // put("/api/contacts/:id")
...
/***/ "../../../../../src/app/shared/basic-validators.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
